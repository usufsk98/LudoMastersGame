...
namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string PlayFabTitleID = "3D6F8";
        public static string PhotonAppID = "2ab58e63-57cd-4dba-a3cd-d02d749240ac";
        public static string PhotonChatID = "7548b6d8-ffc3-43ce-b51a-ef0b48c680b6";
        ...
        // Bids Values
        public static int[] bidValues = new int[] { 0, 500, 2000, 10000, 50000, 250000, 1000000, 2000000, 5000000 };
